...
public class ElencoAgriturismi {
    ...
    public static ElencoAgriturismi caricaCSV(String filename) {
        try(Scanner s = new Scanner(new BufferedReader(new InputStreamReader(ElencoAgriturismi.class.getClassLoader().getResourceAsStream(filename))))) {
